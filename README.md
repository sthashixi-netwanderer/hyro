...
- **ASCII Project Logo**: Features a preformatted ASCII text representation of the project logo (`HYRO`) as the main branding. It is displayed centered at the top of the Sidebar navigation, styled in the custom TitleBar header, and showcased as a bold watermark backdrop inside the Player's full screen overlay.
